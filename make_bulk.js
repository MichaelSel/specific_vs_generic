...
const make_bulk = function (starting_id=0,num_of_sets=11,prefix="SVGb",root='./task_sets/new2') {
...
const make_list = function (list_of_sets,prefix="SVGb",root='./task_sets/new2') {
    if (!fs.existsSync(root)){
        fs.mkdirSync(root);
    }
    let generated_sets = []
